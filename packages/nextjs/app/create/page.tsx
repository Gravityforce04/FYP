...
//                     <p className="text-sm"><strong>Match #{matchId}</strong></p>
//                     <p className="text-sm">Winner: <Address address={matchResult.winner} /></p>
...
//                   onClick={createNFT}
//                   disabled={!image || !price || !name || !description || !matchId || !matchResult?.verified || isCreating}
//                 >
...
//             <li><strong>Verify Match ID:</strong> Enter a Match ID you participated in. Only verified matches are eligible.</li>
//             <li><strong>Upload Image:</strong> Choose an image file (JPG, PNG, GIF) to represent your NFT.</li>
//             <li><strong>Add Details:</strong> Provide a name, description, and price for your NFT.</li>
//             <li><strong>Mint NFT:</strong> Click the button to mint your NFT on the blockchain.</li>
//             <li><strong>List on Marketplace:</strong> After minting, you can list your NFT for sale.</li>
//           </ol>
//         </div>
//       </div>
//     </div>
